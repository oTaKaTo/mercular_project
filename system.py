...
mySystem.search_user_by_email("MOMO@gmail.com").add_address("11121314","sdsds","SAdasd","asdsad","sada","ASDASDS","asdasdsad")
print(mySystem.search_user_by_email("MOMO@gmail.com").get_address())
...
def read_user_infor(email:str):
    return {
            "Username":mySystem.search_user_by_email(email).get_username(),
            "PhoneNumber":mySystem.search_user_by_email(email).get_phone_number(),
            "Email":mySystem.search_user_by_email(email).get_email()
            }
...
def read_user_shipping_address_infor(email:str):
    ...
    k= 1
    for i in mySystem.search_user_by_email(email).get_address():
